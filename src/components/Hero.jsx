  ...
  return (
    <div className='bg-[#fafbfc] pt-24'>
      <div className='flex flex-col items-center justify-center min-h-[60vh] py-16 px-6'>
        ...
        <div className='flex items-center border-2 border-solid border-blue-500 rounded-full h-16 lg:w-2/5 w-full py-2 relative mt-4 '>
            <input type="text" 
            placeholder='Job title or keyword'
            className='bg-transparent h-full w-full border-none outline-none absolute px-20 xl:text-2xl text-base'/>
            <button className='bg-blue-500 rounded-full text-white w-12 h-12 absolute left-2 border-none flex justify-center items-center'> 
